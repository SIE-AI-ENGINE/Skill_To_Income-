...
export const signup = (
  ...
  customFetch<AuthUserType>("/api/auth/signup", {
    ...options,
    method: "POST",
...
export const login = (
  ...
  customFetch<AuthUserType>("/api/auth/login", {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(body),
...
export const logout = (options?: Parameters<typeof customFetch>[1]): Promise<void> =>
  customFetch<void>("/api/auth/logout", { ...options, method: "POST" });
